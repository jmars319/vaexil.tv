...
| Guides4Gamers Sniper Elite 5 | https://guides4gamers.com/sniper-elite-5/maps/campaign-maps/ and DLC map pages | Maps, guide text, marker lists, marker screenshots | Owner-approved private review use only; public publication not approved | Record source in manifest/docs | Private only | All eight main-campaign maps plus Wolf Mountain, Landing Force, Conqueror, Rough Landing, and Kraken Awakes are committed as protected admin draft source plates with draft/unverified marker seeds. Marker prose and screenshots are also imported only as private admin review context and are suppressed from public-style Recon views. Icons and public UI are not copied. |
| Guides4Gamers Sniper Elite: Resistance | https://guides4gamers.com/sniper-elite-resistance/maps/campaign-maps/ and DLC map pages | Maps, guide text, marker lists, marker screenshots | Owner-approved private review use only; public publication not approved | Record source in manifest/docs | Private only | All nine Sniper Elite: Resistance campaign cells plus Lights, Camera, Achtung!, Vercors Vendetta, Striking Range, and Mud and Thunder are committed as protected admin draft source plates with draft/unverified marker seeds. Marker prose and screenshots are also imported only as private admin review context and are suppressed from public-style Recon views. Icons and public UI are not copied. |
...
| GameMappers/MapGenie Sniper Elite 3 | https://gamemappers.com/sniper-elite-3-map/ and https://mapgenie.io/sniper-elite-3/maps/afrika | Interactive map/checklist reference, marker descriptions, marker images | Owner-approved temporary private review use only; public publication not approved | Record source in manifest/docs | Private only | All twelve campaign/DLC maps in scope are committed as protected admin draft source plates with 362 draft/unverified marker seeds. MapGenie marker descriptions and 184 source images are imported only as private admin review context and are suppressed from public-style Recon views. MapGenie UI, icons, checklist state, and public UI are not imported. |
| GameMappers/MapGenie Sniper Elite 4 | https://gamemappers.com/sniper-elite-4-map/ and https://mapgenie.io/sniper-elite-4/maps/italia | Interactive map/checklist reference, marker descriptions, marker images | Owner-approved temporary private review use only; public publication not approved | Record source in manifest/docs | Private only | All twelve campaign/DLC maps in scope are committed as protected admin draft source plates with 564 draft/unverified marker seeds. MapGenie marker descriptions and 149 source images are imported only as private admin review context and are suppressed from public-style Recon views. MapGenie UI, icons, checklist state, and public UI are not imported. |
...
| --- | --- | --- | --- | --- |
| HITMAN World of Assassination floor maps | `private/recon/maps/hitman-*/` | HITMAPS | Third-party source map; private draft review use approved by owner | Yes, private only |
...
| Sniper Elite 5 marker context screenshots | `private/recon/markers/sniper-elite-5/` | Guides4Gamers | Third-party screenshots; private draft review use approved by owner | Yes, private only |
...
| Sniper Elite: Resistance marker context screenshots | `private/recon/markers/sniper-elite-resistance/` | Guides4Gamers | Third-party screenshots; private draft review use approved by owner | Yes, private only |
...
| Sniper Elite 3 marker context images | `private/recon/markers/sniper-elite-3/` | MapGenie | Third-party source images; private draft review use approved by owner | Yes, private only |
...
| Sniper Elite 4 marker context images | `private/recon/markers/sniper-elite-4/` | MapGenie | Third-party source images; private draft review use approved by owner | Yes, private only |
...
No official game icons, publisher screenshots, public UI, checklist state, or
app screenshots were imported. Guides4Gamers marker prose/screenshots and
MapGenie Sniper Elite 3/4 marker prose/images are committed only for private
admin review and must not be published without rewrite/replacement. The only
approved third-party marker-coordinate imports are private draft marker seeds from
Guides4Gamers for Sniper Elite 5/Resistance and MapGenie for legacy SE3/SE4
where compatible source regions exist. They are not public content and must
remain `draft`/`unverified` until first-hand review.
