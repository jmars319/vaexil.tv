...
export const reconCategories: ReconCategory[] = [
  ...
  {
    key: "cardboard_pigeon",
    label: "Cardboard pigeon",
    description: "Cardboard pigeon collectible or challenge target.",
    defaultIconKey: "pigeon",
    defaultVisible: true,
    applicableGames: sniperEliteGames,
    applicableModes: ["campaign"],
  },
  {
    key: "gnome",
    label: "Gnome",
    description: "Gnome collectible or achievement reference.",
    defaultIconKey: "gnome",
    defaultVisible: true,
    applicableGames: sniperEliteGames,
    applicableModes: ["campaign"],
  },
  ...
  },
  {
    key: "fuse_box",
    label: "Fuse box",
    description: "Fuse box or electrical control point.",
  ...
  },
  {
    key: "medal_related",
    label: "Medal-related",
    description: "Mission challenge or medal-related reference point.",
    defaultIconKey: "medal",
    defaultVisible: true,
    applicableGames: sniperEliteGames,
    applicableModes: ["campaign"],
  },
  {
    key: "ammunition",
    label: "Ammunition",
    description: "Ammunition pickup or cache.",
    defaultIconKey: "ammo",
    defaultVisible: false,
    applicableGames: sniperEliteGames,
    applicableModes: ["campaign"],
  },
  {
    key: "medical_item",
    label: "Medical item",
    description: "Bandage, med kit, or related health pickup.",
    defaultIconKey: "medical",
    defaultVisible: false,
    applicableGames: sniperEliteGames,
    applicableModes: ["campaign"],
  },
  {
    key: "supply_pouch",
    label: "Supply pouch",
    description: "Supply pouch or resupply pickup.",
    defaultIconKey: "supply",
    defaultVisible: false,
    applicableGames: sniperEliteGames,
    applicableModes: ["campaign"],
  },
  {
    key: "explosives",
    label: "Explosives",
    description: "Explosive pickup or objective explosive.",
    defaultIconKey: "explosive",
    defaultVisible: false,
    applicableGames: sniperEliteGames,
    applicableModes: ["campaign"],
  },
  {
    key: "vehicle",
    label: "Vehicle",
    description: "Vehicle, tank, or vehicle-related objective.",
    defaultIconKey: "vehicle",
    defaultVisible: true,
    applicableGames: sniperEliteGames,
    applicableModes: ["campaign"],
  },
  {
    key: "passage",
    label: "Passage",
    description: "Door, ladder, tunnel, interior transition, or route connector.",
    defaultIconKey: "entrance",
    defaultVisible: false,
    applicableGames: sniperEliteGames,
    applicableModes: ["campaign"],
  },
  {
    key: "transition",
    label: "Transition",
    description: "Map transition or view-change candidate.",
    defaultIconKey: "route-point",
    defaultVisible: false,
    applicableGames: sniperEliteGames,
    applicableModes: ["campaign"],
  },
  {
    key: "poison_pickup",
    label: "Poison pickup",
    description: "Poison pickup or poison-related opportunity.",
    defaultIconKey: "poison",
    defaultVisible: true,
    applicableGames: sniperEliteGames,
    applicableModes: ["campaign"],
  },
