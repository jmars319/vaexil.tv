...
export const metadata = {
  ...
  description: "Vaexil Recon maps and location guides for Sniper Elite 4.",
};
...
export default async function SniperElite4ReconPage() {
  return renderSniperEliteGamePage({
    ...
    title: "Sniper Elite 4 Recon",
    description:
      "Interactive maps and location guides for Sniper Elite 4. Only reviewed maps and notes are shown.",
    emptyTitle: "No Sniper Elite 4 maps are available yet",
    emptyDescription:
